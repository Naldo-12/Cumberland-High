        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#programs" className="hover:text-emerald-400 transition-colors">Programs</a></li>
              <li><a href="#events" className="hover:text-emerald-400 transition-colors">Events</a></li>
              <li><a href="#news" className="hover:text-emerald-400 transition-colors">News</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Faculty Directory</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Calendar</a></li>
            </ul>
          </div>
